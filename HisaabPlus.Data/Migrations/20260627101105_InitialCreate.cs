    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Unit = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    LowStockLimit = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ShopId = table.Column<int>(type: "int", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerPayments_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "ShopId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockPurchases", x => x.PurchaseId);
                    table.ForeignKey(
                        name: "FK_StockPurchases_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "ShopId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockPurchases_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierPayments_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "ShopId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupplierPayments_Users_PaidBy",
                        column: x => x.PaidBy,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockPurchaseItems", x => x.PurchaseItemId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StockPurchaseItems_StockPurchases_PurchaseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPayments_ShopId",
                table: "CustomerPayments",
                column: "ShopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockPurchaseItems_PurchaseId",
                table: "StockPurchaseItems",
                column: "PurchaseId");

            migrationBuilder.CreateIndex(
                name: "IX_StockPurchases_CreatedBy",
                table: "StockPurchases",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_StockPurchases_ShopId",
                table: "StockPurchases",
                column: "ShopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierPayments_PaidBy",
                table: "SupplierPayments",
                column: "PaidBy");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierPayments_ShopId",
                table: "SupplierPayments",
                column: "ShopId");
